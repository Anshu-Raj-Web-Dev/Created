...
const SignUpForm = () => {
  ...
  const [notification, setNotification] = useState(null); // For notification display
  ...
  const handleSubmit = (e) => {
    ...
    setError(""); // Reset error messages on submission
    setNotification("Signed up successfully!"); // Show success notification
  ...
  return (
    <div>
      {/* <Link href="/" className="logos text-red-600 font-cursive">
        <img src="/logo.png" alt="Logo" width={180} height={10} />
      </Link> */}
